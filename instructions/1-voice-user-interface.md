...
9.  In the textfield provided, replace any existing code with the code provided in the [Interaction Model](https://github.com/alexa/skill-sample-nodejs-calendar-reader/blob/master/InteractionModel.json), then click "Apply Changes" or "Save Model".  
